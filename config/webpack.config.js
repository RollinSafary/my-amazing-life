...
const cordovaBrowserConfig = merge([
  {
    plugins: [
      new CopyWebpackPlugin([
        {
          from: '../platforms/browser/platform_www/cordova.js',
          to: '',
        },
        {
          from: '../platforms/browser/platform_www/cordova_plugins.js',
          to: '',
        },
        {
          from: '../platforms/browser/platform_www/cordova-js-src',
          to: 'cordova-js-src',
        },
        {
          from: '../platforms/browser/platform_www/plugins',
          to: 'plugins',
        },
      ]),
    ],
...
module.exports = (env, modeConfigs) => {
  ...
  const cordovaConfig =
    env === 'browser' || env === 'development' ? cordovaBrowserConfig : {};
  const config = merge(mainConfigs, modeConfig, envConfig, cordovaConfig);
  return config;
};
